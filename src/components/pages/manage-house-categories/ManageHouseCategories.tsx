...
const ManageHouseCategories = () => {
  const { isLoading, columns, dataSource, paginationTotal, onManageAddCategoreis, onChangePage, onPressSearchButton } =
  ...
  return (
    <Layout>
      <div className="flex flex-1 justify-between">
        ...
        <Button color="primary" variant="flat" className="min-w-[120px]" onPress={onManageAddCategoreis}>
          + Add House Category
        </Button>
      </div>
      <Table
